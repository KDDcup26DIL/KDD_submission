...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--rank_mixer_mode', type=str, default='unimixer',
                        choices=['full', 'ffn_only', 'none', 'unimixer'],
    ...
    parser.add_argument('--ns_tokenizer_type', type=str, default='unimixer',
                        choices=['group', 'rankmixer', 'unimixer'],
                        help='NS tokenizer variant: '
                             ...
                             'unimixer = learn field-token mixing to NS tokens')
