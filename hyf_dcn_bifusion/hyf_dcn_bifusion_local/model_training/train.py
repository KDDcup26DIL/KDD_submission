"""PCVRHyFormerDCNBifusion training entry point (self-contained baseline).
...
from model import PCVRHyFormerDCNBifusion
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="PCVRHyFormerDCNBifusion Training")
...
def main() -> None:
    ...
    model = PCVRHyFormerDCNBifusion(**model_args).to(args.device)

    # Log model sizing info.
    logging.info(
        f"PCVRHyFormerDCNBifusion model created: d_model={args.d_model}, emb_dim={args.emb_dim}, "
