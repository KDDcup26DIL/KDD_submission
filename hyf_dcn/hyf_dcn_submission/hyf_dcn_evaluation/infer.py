"""PCVRHyFormerDCN inference script (uploaded by the contestant into the
...
from model import PCVRHyFormerDCN, ModelInput
...
def build_model(
    ...
    """Construct a ``PCVRHyFormerDCN`` from the dataset schema and model config.
    ...
    logging.info(f"Building PCVRHyFormerDCN with cfg: {model_cfg}")
    model = PCVRHyFormerDCN(
