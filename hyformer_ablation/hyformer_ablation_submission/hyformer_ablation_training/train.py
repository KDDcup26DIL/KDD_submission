...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--query_context_mode', type=str, default='ns_seq',
                        choices=['ns_seq', 'ns_only', 'seq_only', 'ns_zero_seq'],
                        help='Ablate query/global conditioning inputs: '
                             'ns_seq=NS+seq mean, ns_only=NS only, '
                             'seq_only=sequence mean only, ns_zero_seq=NS plus zeroed seq slot')
