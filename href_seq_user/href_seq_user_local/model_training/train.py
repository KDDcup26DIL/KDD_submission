...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_click_user_init', action='store_true', default=False,
    ...
    parser.add_argument('--use_seq_user_init', action='store_true', default=True,
                        help='Enable label-free sequence user init fused into F_u')
    parser.add_argument('--no_seq_user_init', dest='use_seq_user_init',
                        action='store_false',
                        help='Disable sequence user init')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_seq_user_init": args.use_seq_user_init,
