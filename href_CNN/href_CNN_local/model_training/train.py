...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--seq_summary_type', type=str, default='cnn',
                        choices=['mean', 'cnn'],
                        help='How to summarize each sequence domain for query generation')
    parser.add_argument('--seq_cnn_kernel', type=int, default=5,
                        help='Odd kernel size for the CNN sequence summary')
...
def main() -> None:
    ...
    model_args = {
        ...
        "seq_summary_type": args.seq_summary_type,
        "seq_cnn_kernel": args.seq_cnn_kernel,
    }
