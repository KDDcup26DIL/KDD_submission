...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--shape", type=parse_int_list, default=[52,52,52])
    parser.add_argument("--net_ex_dropout", type=float, default=0.01)
    parser.add_argument("--net_im_dropout", type=float, default=0.01)
